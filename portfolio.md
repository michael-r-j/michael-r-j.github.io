...
<p>
  ...
  <table style="width:100%;">
    <tr>
    {% for j in (1..9) %}
      <td><a href="/Kunst/Bonn/Akt/assorted/00{{ j }}.jpg"><img src="/Kunst/Bonn/Akt/assorted/thumbs/00{{ j }}.jpg" style="width:100%;"></a></td>
    ...
    {% endfor %}
    {% for j in (0..6) %}
      <td><a href="/Kunst/Bonn/Akt/assorted/01{{ j }}.jpg"><img src="/Kunst/Bonn/Akt/assorted/thumbs/01{{ j }}.jpg" style="width:100%;"></a></td>
    {% assign row = forloop.index | modulo:4 %}
    {% if row == 3 %}
    </tr>
    <tr>
